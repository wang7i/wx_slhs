...
Page({
    ...
    onLoad: function (options) {
        wx.request({
            url: app.globalData.ip + '/date-prices/1',
            method: 'GET',
            success: res => {
                console.log(res)
            }
    ...
    selectAction: function (e) {
        ...
        if (this.data.startDate && this.data.endDate) {
            ...
            if ((this.data.startDate > this.data.endDate) == true) {
                this.data.startDate = Data.formatDate(selectDate, "yyyy-MM-dd");
                this.data.endDate = null;
            }
    ...
    save:function() {
        if (this.data.startDate && this.data.endDate) {
            var sDate = this.data.startDate;
            var eDate = this.data.endDate;
            var days = new Date(this.data.endDate).getTime() - new Date(this.data.startDate).getTime();
